...
switch (playerSide) do {
    case west: {
        ...
        //Nov_Loan
        LOAN = parseNumber (_this select 12);
    ...
    case civilian: {
        ...
        //Nov_Loan
        LOAN = parseNumber (_this select 13);
        LIVREA = parseNumber(_this select 14);
    ...
    case independent: {
        ...
        //Nov_Loan
        LOAN = parseNumber(_this select 11);
